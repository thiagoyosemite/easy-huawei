        ...
        <div className="flex gap-4 mb-8">
          <button
            ...
            className={"flex-1 py-2 px-4 rounded-md transition-colors " + 
              (selectedView === "dashboard" ? "bg-purple-600 text-white" : "bg-purple-100 text-purple-600 hover:bg-purple-200")}
          >
            Dashboard
          </button>
          <button
            ...
            className={"flex-1 py-2 px-4 rounded-md transition-colors " + 
              (selectedView === "onus" ? "bg-green-500 text-white" : "bg-green-100 text-green-600 hover:bg-green-200")}
          >
            ONUs
          </button>
        </div>
